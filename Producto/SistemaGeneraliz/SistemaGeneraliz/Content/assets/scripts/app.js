...
var App = function () {
    ...
    var handleHorizontalMenu = function () {
        ...
        $('.header .hor-menu .hor-menu-search-form-toggler').on('click', function (e) {
        ...
        $('.header .hor-menu .search-form .btn').on('click', function (e) {
            window.location.href = "extra_search.html";
            e.preventDefault();
        });

        //handle hor menu search form on enter press
        $('.header .hor-menu .search-form input').on('keypress', function (e) {
            if (e.which == 13) {
                window.location.href = "extra_search.html";
                return false;
            }
    ...
    var handlePortletTools = function () {
        jQuery('.portlet .tools a.remove').on('click', function () {
        ...
        jQuery('.portlet .tools a.reload').on('click', function () {
        ...
        jQuery('.portlet .tools .collapse, .portlet .tools .expand').on('click', function () {
    ...
    var handleFixInputPlaceholderForIE = function () {
        ...
        if (navigator.userAgent.match(/msie [8]/i) || navigator.userAgent.match(/msie [7]/i)) { // ie7&ie8
