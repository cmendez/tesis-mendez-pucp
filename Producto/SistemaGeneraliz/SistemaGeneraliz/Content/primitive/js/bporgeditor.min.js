/*
 Basic Primitives orgEditor Demo v1.0.34
...
primitives.orgeditor.checkColor=function(a,b,c){var d=primitives.common.getColorHexValue(b.val()),e=/^#[0-9a-f]{3}([0-9a-f]{3})?$/i;null==d||!e.test(d)?(b.addClass("ui-state-error"),primitives.orgeditor.updateTips(a,c+" has wrong color value: "+d),a=!1):(b.val(d),a=!0);return a};
primitives.orgeditor.checkNumber=function(a,b,c,d){var e=b.val();d&&primitives.common.isNullOrEmpty(e)?a=!0:null==e||isNaN(parseFloat(e))||!isFinite(e)?(b.addClass("ui-state-error"),primitives.orgeditor.updateTips(a,c+" has wrong decimal value: "+e),a=!1):(b.val(e),a=!0);return a};primitives.orgeditor.TemplateName={Default:"",Contact:"contactTemplate",PlainDescription:"plainDescriptionTemplate",Invisible:"invisibleTemplate"};primitives.orgeditor.UserTemplate=function(){this.name=""};
...
primitives.orgeditor.Controller=function(){this.widgetEventPrefix="bporgeditor";this.options=new primitives.orgeditor.Config;this.selectedItem=this.dlgMessage=this.dlgCodeMirror=this.dlgConfig=this.dlgItemConfig=this.dlgOrgChart=this.orgDiagram=this.formsPlaceholder=null;this.fieldsToClone="pageFitMode orientationType verticalAlignment horizontalAlignment connectorType minimalVisibility selectionPathMode leavesPlacementType childrenPlacementType normalLevelShift dotLevelShift lineLevelShift normalItemsInterval dotItemsInterval lineItemsInterval itemTitleFirstFontColor itemTitleSecondFontColor defaultTemplateName showLabels labelOrientation labelPlacement labelSize rootItem".split(" ");this.userTemplates=
{contactTemplate:new primitives.orgeditor.UserTemplateContact,plainDescriptionTemplate:new primitives.orgeditor.UserTemplateDescription,invisibleTemplate:new primitives.orgeditor.UserTemplateInvisible}};primitives.orgeditor.Controller.prototype._create=function(){this.element.addClass("bp-item");this._createLayout()};primitives.orgeditor.Controller.prototype.destroy=function(){this._cleanLayout()};
...
primitives.orgeditor.DlgCodeMirror.prototype._createLayout=function(){new primitives.common.Rect(0,0,this.element.outerWidth(),this.element.outerHeight());this.placeholder=jQuery('<div style="overflow: hidden; padding:0; margin:0; border: 0px;"><form><textarea name="content"></textarea></form></div>').addClass(this.widgetEventPrefix);this.element.append(this.placeholder);this.element.addClass("dialog-form");this.content=this.element.find("[name=content]")};
...
this.pageFitMode=null;this.enums={pageFitMode:{name:primitives.orgdiagram.PageFitMode,title:"Page Fit Mode",isString:!1},orientationType:{name:primitives.orgdiagram.OrientationType,title:"Orientation",isString:!1},verticalAlignment:{name:primitives.common.VerticalAlignmentType,title:"Items Vertical Alignment",isString:!1},horizontalAlignment:{name:primitives.common.HorizontalAlignmentType,title:"Items Horizontal Alignment",isString:!1},connectorType:{name:primitives.orgdiagram.ConnectorType,title:"Connectors",
isString:!1},minimalVisibility:{name:primitives.orgdiagram.Visibility,title:"Minimal nodes visibility",isString:!1},selectionPathMode:{name:primitives.orgdiagram.SelectionPathMode,title:"Selection Path Mode",isString:!1},childrenPlacementType:{name:primitives.orgdiagram.ChildrenPlacementType,title:"Children placement",isString:!1},leavesPlacementType:{name:primitives.orgdiagram.ChildrenPlacementType,title:"Leaves placement",isString:!1},defaultTemplateName:{name:primitives.orgeditor.TemplateName,
...
primitives.orgeditor.DlgConfig.prototype._createWidgets=function(){var a,b,c,d;d=[];this.tips=this.element.find(".validateTips");this.labelWidth=this.element.find("[name=labelWidth]");this.labelHeight=this.element.find("[name=labelHeight]");this.itemTitleFirstFontColor=this.element.find("[name=itemTitleFirstFontColor]");this.itemTitleSecondFontColor=this.element.find("[name=itemTitleSecondFontColor]");for(b in primitives.common.Colors)primitives.common.Colors.hasOwnProperty(b)&&d.push(b);this.itemTitleFirstFontColor.autocomplete({source:d});
this.itemTitleSecondFontColor.autocomplete({source:d});for(a in this.enums)if(this.enums.hasOwnProperty(a)){b=this.enums[a];this[a]=this.element.find("[name="+a+"]");for(c in b.name)b.name.hasOwnProperty(c)&&(d=b.name[c],this[a].append(jQuery("<option value='"+d+"'>"+c+"</option>")));this[a].buttonset()}};primitives.orgeditor.DlgConfig.prototype._cleanLayout=function(){this.element.empty();this.element.removeClass("dialog-form")};
primitives.orgeditor.DlgConfig.prototype.open=function(a){var b=jQuery([]).add(this.itemTitleFirstFontColor).add(this.itemTitleSecondFontColor),c=this,a=void 0!==a?a:new primitives.orgdiagram.ItemConfig;this._updateWidgets(a);this.element.dialog({autoOpen:!1,height:400,width:350,modal:!0,title:"Chart options",buttons:{Save:function(){var d=!0;b.removeClass("ui-state-error");if(d=(d=(d=(d=(d=(d=d&&primitives.orgeditor.checkLength(c.tips,c.itemTitleFirstFontColor,"Title first font color",0,20))&&primitives.orgeditor.checkLength(c.tips,
c.itemTitleSecondFontColor,"Title second font color",0,20))&&primitives.orgeditor.checkColor(c.tips,c.itemTitleFirstFontColor,"Title first font color"))&&primitives.orgeditor.checkColor(c.tips,c.itemTitleSecondFontColor,"Title second font color"))&&primitives.orgeditor.checkNumber(c.tips,c.labelWidth,"Label width"))&&primitives.orgeditor.checkNumber(c.tips,c.labelHeight,"Label height"))c._updateConfig(a),jQuery(this).dialog("close"),c._trigger("update",null,a)},Cancel:function(){jQuery(this).dialog("close");
c._trigger("cancel",null,a)}},close:function(){b.val("").removeClass("ui-state-error");c._trigger("cancel",null,a)}}).dialog("open")};
...
primitives.orgeditor.DlgConfig.prototype._getFirstEnumItem=function(a){for(var b in a)if(a.hasOwnProperty(b))return a[b];return null};
...
primitives.orgeditor.DlgConfig.prototype._setOption=function(a,b){jQuery.Widget.prototype._setOption.apply(this,arguments)};(function(a){a.widget("ui.bpDlgConfig",new primitives.orgeditor.DlgConfig)})(jQuery);primitives.orgeditor.DlgItemConfigOptions=function(){this.update=this.cancel=null};
...
null;this.textFields={title:{title:"Title"},itemTitleColor:{title:"Title Color"},description:{title:"Description"},phone:{title:"Phone"},email:{title:"E-mail"},groupTitle:{title:"Group Title"},groupTitleColor:{title:"Group Title Color"},image:{title:"Photo"},readmorelabel:{title:"Read more label"},readmoreurl:{title:"Read more URL"},label:{title:"Label"}};this.tips=null;this.enums={itemType:{name:{Regular:0,Assistant:1,Adviser:2,SubAssistant:4,SubAdviser:5},title:"Item type",isString:!1},adviserPlacementType:{name:primitives.orgdiagram.AdviserPlacementType,
title:"Adviser placement",isString:!1},childrenPlacementType:{name:primitives.orgdiagram.ChildrenPlacementType,title:"Children placement",isString:!1},templateName:{name:primitives.orgeditor.TemplateName,title:"Item template",isString:!0},showLabel:{name:primitives.common.Enabled,title:"Show labels",isString:!1},labelOrientation:{name:primitives.text.TextOrientationType,title:"Labels orientation",isString:!1},labelPlacement:{name:primitives.common.PlacementType,title:"Labels placement",isString:!1}}};
primitives.orgeditor.DlgItemConfig.prototype._create=function(){this._createLayout()};primitives.orgeditor.DlgItemConfig.prototype.destroy=function(){this._cleanLayout()};
...
(b=this.textFields[a],c+='<br/><label for="'+a+'">'+b.title+'</label><input type="text" name="'+a+'" class="text ui-widget-content ui-corner-all" />');for(a in this.enums)this.enums.hasOwnProperty(a)&&(b=this.enums[a],c+='<br/><label for="'+a+'">'+b.title+'</label><select class="text ui-widget-content ui-corner-all" style="padding:2px; margin:5px;" name="'+a+'"></select>');c+='<br/><label for="labelWidth">Label width</label><input type="text" name="labelWidth" class="text ui-widget-content ui-corner-all" /><br/><label for="labelHeight">Label height</label><input type="text" name="labelHeight" class="text ui-widget-content ui-corner-all" />';
c+="</fieldset></form>";c+="</div>";c+='<div id="'+this.widgetEventPrefix+'order">';c+='<ul name="sortable" class="sortable"></ul>';c+="</div>";a=jQuery(c).addClass(this.widgetEventPrefix);this.element.append(a);this.element.addClass("dialog-form");this._createWidgets()};
...
(d=f.name[c],this[e].append(jQuery("<option value='"+d+"'>"+c+"</option>")));this[e].buttonset()}for(b in primitives.common.Colors)primitives.common.Colors.hasOwnProperty(b)&&a.push(b);this.itemTitleColor.autocomplete({source:a});this.groupTitleColor.autocomplete({source:a});this.labelWidth=this.element.find("[name=labelWidth]");this.labelHeight=this.element.find("[name=labelHeight]")};primitives.orgeditor.DlgItemConfig.prototype._cleanLayout=function(){this.element.empty();this.element.removeClass("dialog-form")};
primitives.orgeditor.DlgItemConfig.prototype.open=function(a){var b=this,a=void 0!==a?a:new primitives.orgdiagram.ItemConfig;this._updateWidgets(a);this.element.dialog({autoOpen:!1,height:400,width:350,modal:!0,title:"Item options",buttons:{Save:function(){var c=!0,d;for(d in b.textFields)b.textFields.hasOwnProperty(d)&&b[d].removeClass("ui-state-error");if(c=(c=(c=(c=(c=(c=(c=(c=c&&primitives.orgeditor.checkLength(b.tips,b.title,"Title",1,80))&&primitives.orgeditor.checkLength(b.tips,b.description,
"Description",0,400))&&primitives.orgeditor.checkLength(b.tips,b.itemTitleColor,"Title color",0,40))&&primitives.orgeditor.checkLength(b.tips,b.groupTitleColor,"Group title color",0,40))&&primitives.orgeditor.checkColor(b.tips,b.itemTitleColor,"Title color"))&&primitives.orgeditor.checkColor(b.tips,b.groupTitleColor,"Group title color"))&&primitives.orgeditor.checkNumber(b.tips,b.labelWidth,"Label width",!0))&&primitives.orgeditor.checkNumber(b.tips,b.labelHeight,"Label height",!0))b._updateItemConfig(a),
jQuery(this).dialog("close"),b._trigger("update",null,a)},Cancel:function(){jQuery(this).dialog("close");b._trigger("cancel",null,a)}},close:function(){for(var c in b.textFields)b.textFields.hasOwnProperty(c)&&b[c].val("").removeClass("ui-state-error");b._trigger("cancel",null,a)}}).dialog("open")};
...
this.labelWidth.val(null!=a.labelSize?a.labelSize.width:"");this.labelHeight.val(null!=a.labelSize?a.labelSize.height:"")};primitives.orgeditor.DlgItemConfig.prototype._getFirstEnumItem=function(a){for(var b in a)if(a.hasOwnProperty(b))return a[b];return null};
primitives.orgeditor.DlgItemConfig.prototype._updateItemConfig=function(a){var b,c,d,e;for(c in this.textFields)this.textFields.hasOwnProperty(c)&&(a[c]=this[c].val());for(b in this.enums)this.enums.hasOwnProperty(b)&&(c=this[b].val(),a[b]=this.enums[b].isString?c:parseInt(c,10));d=this.sortableList.sortable("toArray");if(0<d.length){e=[];b=0;for(c=d.length;b<c;b+=1)e.push(a.items[parseInt(d[b],10)]);a.items.length=0;a.items=e}b=parseFloat(this.labelWidth.val());c=parseFloat(this.labelHeight.val());
a.labelSize=0<b&&0<c?new primitives.common.Size(b,c):null};primitives.orgeditor.DlgItemConfig.prototype._setOption=function(a,b){jQuery.Widget.prototype._setOption.apply(this,arguments)};(function(a){a.widget("ui.bpDlgItemConfig",new primitives.orgeditor.DlgItemConfig)})(jQuery);primitives.orgeditor.DlgOrgDiagramOptions=function(){this.update=this.cancel=null};
primitives.orgeditor.DlgOrgDiagram=function(){this.widgetEventPrefix="bpdlgorgdiagram";this.options=new primitives.orgeditor.DlgOrgDiagramOptions;this.orgdiagram=null};primitives.orgeditor.DlgOrgDiagram.prototype._create=function(){this._createLayout()};primitives.orgeditor.DlgOrgDiagram.prototype.destroy=function(){this._cleanLayout()};
